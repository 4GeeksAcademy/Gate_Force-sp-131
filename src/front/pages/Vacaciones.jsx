...
export default function VacacionesEmployee() {
        ...
        return (
            <div className="container mt-5">
                <div className="alert alert-warning">
                    Debes estar logueado como empleado o admin para ver esta vista.
                </div>
            </div>
        );
    }
    ...
    return (
        <div style={{ padding: "20px" }}>
            ...
            >
                <h1>{role === "admin" ? "Vacaciones" : "Mis Vacaciones"}</h1>
            ...
            <ul style={{ padding: 0 }}>
                {misVacaciones.length === 0 ? (
                    ...
                    misVacaciones.map((vacacion) => (
                        ...
                        >
                            {role === "admin" && vacacion.employee_name && (
                                <div style={{ marginBottom: "6px" }}>
                                    <strong>Empleado: </strong>{vacacion.employee_name}
                                </div>
                            )}
                            ...
                            <div>
                                ...
                                <span
                                    style={{
                                        color:
                                            vacacion.status === "approved"
                                                ? "green"
                                                : vacacion.status === "rejected"
                                                    ? "red"
                                                    : "orange",
