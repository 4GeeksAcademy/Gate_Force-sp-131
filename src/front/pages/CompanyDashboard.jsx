    ...
    return (
        <div className="container py-4">
            ...
            <div className="row g-3 mb-4">
                <StatCard icon="👥" iconBg="bg-primary" label="Total Employees" value={stats.employees} />
                <StatCard icon="⏪" iconBg="bg-success" label="Currently Working" value={stats.activeClocks} />
                <StatCard icon="⏳" iconBg="bg-warning" label="Pending Requests" value={stats.pendingVacations} />
                <StatCard icon="💬" iconBg="bg-info" label="Unread Messages" value={stats.unreadMessages} />
            </div>
                ...
                <div className="col-12 col-lg-6">
                    <div className="card border-0 shadow-sm rounded-4 h-100 bg-warning text-dark">
                        <div className="card-body p-4 d-flex flex-column justify-content-between">
                            <div className="d-flex justify-content-between align-items-start mb-4">
                                <div>
                                    <div className="small text-dark text-opacity-75 text-uppercase fw-bold mb-1">Currently Working</div>
                            ...
                            <button onClick={() => navigate("/work-logs")} className="btn btn-dark fw-bold text-warning rounded-pill">
